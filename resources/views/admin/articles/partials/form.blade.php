...
<input type="text" class="form-control" name="title" placeholder="Заголовок категории" value="{{$article->title ?? ""}} " required>
...
<input type="text" class="form-control" name="meta_title" placeholder="Мета категории" value="{{$article->meta_title ?? ""}}">

<label for="">Мета описание</label>
<input type="text" class="form-control" name="meta_description" placeholder="Мета описание" value="{{$article->meta_description ?? ""}}">

<label for="">Ключеные слова</label>
<input type="text" class="form-control" name="meta_keyword" placeholder="Ключеные слова" value="{{$article->meta_keyword ?? ""}}">
